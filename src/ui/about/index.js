...
class About extends Component {
	...
	render() {
		return this.html`
			<h2>Cylix Guide</h2>
			<p>Cylix Guide is a compendium of items found within the game Halo Infinite. As an open source project its goals are to make information about the live game accessible, and seeks to archive that information along with its changes over time.</p>
			<h2>Disclaimer</h2>
			...
			<p>The original assets (e.g. code) used for this website, not associated with Microsoft, are available under the ISC license. To contribute, report issues, or contact me, please visit the <a href="https://github.com/Gasgira/gasgira.github.io" target="_blank" rel="noopener noreferrer">GitHub repository</a> for this project. All contributions must be made under the same license and terms.</p>
