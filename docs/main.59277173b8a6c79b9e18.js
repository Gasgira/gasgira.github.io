		...
		return this.html`
			<div class="discord_wrapper">
				<section>
					...
					<p>Cylix Guide does not collect information from visitors unless explicitly submitted, e.g. through a form. Any information submitted is not shared outside of the data processors referred to in this policy, and is only used by Cylix Guide for purposes described in the submission form.</p><br/>
...
module.exports = __webpack_require__.p + "c41a712c582ebf91d6f6.svg";
