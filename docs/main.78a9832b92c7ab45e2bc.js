...
class App {
	async init() {
		...
		Promise.all([
			...
			ui_inventory__WEBPACK_IMPORTED_MODULE_6__.inventory.init()
		]).then(() => {
			this.parseUri();
			this.render();
		})
...
/* harmony import */ var lib_HTML__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lib/HTML */ "./src/lib/HTML/index.js");
/* harmony import */ var db__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! db */ "./src/db/index.js");
/* harmony import */ var urlParams__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! urlParams */ "./src/urlParams/index.js");
/* harmony import */ var ui_mica__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ui/mica */ "./src/ui/mica/index.js");
/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index.css */ "./src/ui/calendar/index.css");
...
class Calendar extends component__WEBPACK_IMPORTED_MODULE_0__.Component {
	constructor() {
		...
		this.mobileMicaMenu = new ui_mica__WEBPACK_IMPORTED_MODULE_5__.MobileMicaMenu('MobileMicaMenu-Calendar', 'Events');
	...
	async init() {
		...
		Promise.allSettled([...this?.rewardTracks.values()].map(rewardTrack => rewardTrack.init()))
			.then(() => {
				...
				const paramEvent = urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('calendar');
	...
	showRewardTrack(rewardTrack) {
		...
		urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('calendar', rewardTrack?.name);
		this.scrollIntoView();
	}
	...
	showCalendar() {
		...
		urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.deleteSecionSetting('calendar');
		this.scrollIntoView();
	}
					...
					<ul class="rank_rewards">
						...
						<ul class="rank_reward-items free">
							${rank?.FreeRewards?.InventoryRewards?.map(reward => {
								return lib_HTML__WEBPACK_IMPORTED_MODULE_2__.HTML.wire()`<li>${new db__WEBPACK_IMPORTED_MODULE_3__.Item(reward?.InventoryItemPath).renderIcon('reward', {itemTypeIcon: true})}</li>`
							})}
							${rank?.FreeRewards?.CurrencyRewards?.map(reward => {
								return lib_HTML__WEBPACK_IMPORTED_MODULE_2__.HTML.wire()`<li class="currency" data-quantity=${parseInt(reward?.Amount)}>${new db__WEBPACK_IMPORTED_MODULE_3__.CurrencyItem(reward?.CurrencyPath).renderIcon(`${rank.Rank}-${performance.now()}`)}</li>`
							})}
						</ul>
...
class CoreViewer extends component__WEBPACK_IMPORTED_MODULE_0__.Component {
	...
	async init() {
		...
		const paramCoreType = urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('coreType');
		if (paramCoreType && this.coreTypes.has(paramCoreType))
		{
			this.showCoreType(paramCoreType, true)
			// console.log('ct init', paramCoreType);
			const coreName = urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('coreName');
			if (coreName)
			{
	...
	updateParams() {
		urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('coreType', this.state?.coreTypeName ?? 'unk');
		urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('coreName', this.state?.core?.name ?? 'unk');
		if (this.state?.core?.state?.socket)
		{
			urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('coreSocket', this.state?.core?.state?.socket?.socketName ?? 'unk');
		} else {
			urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.deleteSecionSetting('coreSocket');
		}
	}
...
class Core extends component__WEBPACK_IMPORTED_MODULE_0__.Component {
	...
	async init() {
		...
		const paramSocketName = urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('coreSocket');
		...
		this.mobileMicaMenu = new ui_mica__WEBPACK_IMPORTED_MODULE_5__.MobileMicaMenu(`MobileMicaMenu-${this.name}`, 'Sockets');
		eventEmitter__WEBPACK_IMPORTED_MODULE_2__.emitter.on(`MobileMicaMenu-${this.name}`, () => {
			this.setState({mobileMenu: !this.state.mobileMenu});
		});
...
class Inventory extends component__WEBPACK_IMPORTED_MODULE_0__.Component {
	async init() {
		...
		const paramCategoryName = urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('inventory');
		const paramBundle = urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('bundle');
		...
		this.mobileMicaMenu = new ui_mica__WEBPACK_IMPORTED_MODULE_5__.MobileMicaMenu('MobileMicaMenu-Inventory', 'Categories');
		eventEmitter__WEBPACK_IMPORTED_MODULE_2__.emitter.on('MobileMicaMenu-Inventory', () => {
			this.setState({mobileMenu: !this.state.mobileMenu});
		});
	...
	showCategory(inventoryCategory) {
		...
		urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('inventory', inventoryCategory?.categoryName ?? 'unk');
		this.scrollIntoView();
	}
...
class InventoryCategory extends component__WEBPACK_IMPORTED_MODULE_0__.Component {
	...
	getCurrentItemPage() {
		return (this.items = [...this.currentPageIDs].map(id => new db__WEBPACK_IMPORTED_MODULE_1__.Item(db__WEBPACK_IMPORTED_MODULE_1__.db.getItemPathByID(id))));
	}
	...
	renderPageControls(id = upper) {
		...
		return lib_HTML__WEBPACK_IMPORTED_MODULE_3__.HTML.wire(this, `:${id}`)`
...
class Search extends InventoryCategory {
	init() {
		// this.items = new Set();
		const term = urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('s');
		if (!this.state.term && term && typeof term === 'string')
		{
			this.state.term = term;
		}
		
		const modifiedDateString = urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('smd');
			...
			<ul class="inventory-search-filters">
				<li class="filter-input_wrapper">
					...
					<input
						...
						value=${urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('smd')
							? `${urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.getSecionSetting('smd')}`
							: ''
						}
					>
				</li>
	...
	submit() {
		if ((!this.state.term || typeof this.state.term !== 'string') && !this.state.filters.size)
		{
			this.items = new Set();
			this.itemIDs = new Set();
			urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.deleteSecionSetting('s');
			this.render();
			return;
		}
		console.log('submit', this.state.term, this.state.filters);
		urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('s', this.state.term);
		this.searchItems();
		this.render();
	...
	filterModifiedDate(dateString) {
		...
		if (!dateString || !Date.parse(dateString))
		{
			...
			urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.deleteSecionSetting('smd');
			return;
		}
		...
		urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('smd', `${dateString}`);
	}
	...
	render() {
		return this.html`
			...
			<a class="header-logo" href="/"><header>
				...
				<ul>
					<li><button aria-label="Search" onclick=${() => eventEmitter__WEBPACK_IMPORTED_MODULE_2__.emitter.emit('nav-search')}><div class="icon-masked icon-search"></div></button></li>
					<li><button aria-label="Settings" onclick=${() => ui_modal__WEBPACK_IMPORTED_MODULE_5__.modalConstructor.showView(ui_settings__WEBPACK_IMPORTED_MODULE_3__.settings.render())}><div class="icon-masked icon-settings"></div></button></li>
					<li><button aria-label="Disclaimer" onclick=${() => ui_modal__WEBPACK_IMPORTED_MODULE_5__.modalConstructor.showView(ui_about__WEBPACK_IMPORTED_MODULE_4__.about.render())}>Disclaimer</button></li>
				</ul>
			</nav>
		`;
	}
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("78a9832b92c7ab45e2bc")
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=main.78a9832b92c7ab45e2bc.js.map