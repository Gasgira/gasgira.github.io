"use strict";(self.webpackChunkcylixguide=self.webpackChunkcylixguide||[]).push([[496],{3622:(t,e,s)=>{s.r(e),s.d(e,{default:()=>o});var i=s(8081),r=s.n(i),a=s(3645),n=s.n(a)()(r());n.push([t.id,'.ugc_detail-panel {\r\n\t--edge-pad: 0.75rem;\r\n\tpadding-bottom: 5rem;\r\n\t--rarity: #000\r\n}\n.ugc_detail-panel.is343 {\r\n\t\t--rarity: var(--rarity-store);\r\n\t}\n.ugc_detail-panel.isRec {\r\n\t\t--rarity: var(--theme-activate);\r\n\t}\n.ugc_detail-panel header.asset-title {\r\n\t\tfont-size: 1.5rem;\r\n\t\tpadding: 1rem 2rem;\r\n\t\tposition: relative\r\n\t}\n.ugc_detail-panel header.asset-title::before {\r\n\t\t\tcontent: "";\r\n\t\t\tposition: absolute;\r\n\t\t\ttop: 0;\r\n\t\t\tleft: 0;\r\n\t\t\twidth: 100%;\r\n\t\t\theight: 100%;\r\n\t\t\tz-index: -1;\r\n\t\t\tdisplay: block;\r\n\t\t\tpointer-events: none;\r\n\t\t\tbackground: linear-gradient(-4deg, var(--rarity), rgba(0,0,0,0) 60%);\r\n\t\t\t-webkit-mask: var(--noise), linear-gradient(-4deg, #000 30%, transparent 55%);\r\n\t\t\t        mask: var(--noise), linear-gradient(-4deg, #000 30%, transparent 55%);\r\n\t\t}\n.ugc_detail-panel .img-viewer_wrapper {\r\n\t\tbackground-color: rgba(0,0,0,0.25)\r\n\t}\n.ugc_detail-panel .img-viewer_wrapper .img-viewer {\r\n\t\t\tbox-shadow: 0 1rem 1rem rgba(0,0,0,0.25);\r\n\t\t\tmax-width: 100%;\r\n\t\t\theight: auto;\r\n\t\t\tmax-height: 50vh;\r\n\t\t\t-o-object-fit: contain;\r\n\t\t\t   object-fit: contain;\r\n\t\t\tbackground-color: rgba(0,0,0,0.5);\r\n\t\t\ttransition: opacity var(--time-state) linear;\r\n\t\t\topacity: 0\r\n\t\t}\n.ugc_detail-panel .img-viewer_wrapper .img-viewer.broken {\r\n\t\t\t\t/* display: none; */\r\n\t\t\t}\n.ugc_detail-panel .quick-stats {\r\n\t\tmax-width: 100%;\r\n\t\tlist-style-type: none;\r\n\t\tdisplay: flex;\r\n\t\tflex-direction: row;\r\n\t\tflex-wrap: wrap;\r\n\t\tjustify-content: space-evenly;\r\n\t\tgap: 0.5rem;\r\n\t\tpadding: 1rem var(--edge-pad)\r\n\t}\n.ugc_detail-panel .quick-stats li {\r\n\t\t\tdisplay: flex;\r\n\t\t\tflex-direction: column-reverse;\r\n\t\t\tjustify-content: center;\r\n\t\t\talign-items: center;\r\n\t\t}\n.ugc_detail-panel .overview .description {\r\n\t\t\tdisplay: flex;\r\n\t\t\tflex-direction: column;\r\n\t\t\tposition: relative;\r\n\t\t\tpadding: 1.5rem var(--edge-pad);\r\n\t\t\tbox-shadow: 0 1rem 1rem rgba(0,0,0,0.25);\r\n\t\t\tmargin-bottom: 3rem\r\n\t\t}\n.ugc_detail-panel .overview .description .date-modified {\r\n\t\t\t\tfont-size: 0.9rem;\r\n\t\t\t\topacity: 0.66;\r\n\t\t\t\tdisplay: flex;\r\n\t\t\t\tflex-direction: row;\r\n\t\t\t\talign-items: center;\r\n\t\t\t}\n.ugc_detail-panel .overview .description .text {\r\n\t\t\t\tfont-size: 1.2rem;\r\n\t\t\t\tfont-style: italic;\r\n\t\t\t}\n.ugc_detail-panel .overview .description::before, .ugc_detail-panel .overview .description::after {\r\n\t\t\t\tcontent: "";\r\n\t\t\t\tposition: absolute;\r\n\t\t\t\ttop: 0;\r\n\t\t\t\tleft: 0;\r\n\t\t\t\tright: 0;\r\n\t\t\t\tbottom: 0;\r\n\t\t\t\tz-index: -1;\r\n\t\t\t\tdisplay: block;\r\n\t\t\t\tpointer-events: none;\r\n\t\t\t}\n.ugc_detail-panel .overview .description::before {\r\n\t\t\t\topacity: 0.66;\r\n\t\t\t\tbackground: linear-gradient(30deg, var(--bg3), rgba(0,0,0,0) 80%);\r\n\t\t\t\t-webkit-mask: var(--noise), linear-gradient(30deg, #000 10%, transparent 75%);\r\n\t\t\t\t        mask: var(--noise), linear-gradient(30deg, #000 10%, transparent 75%);\r\n\t\t\t}\n.ugc_detail-panel .overview .tags {\r\n\t\t\tmax-width: 100%;\r\n\t\t\tlist-style-type: none;\r\n\t\t\tdisplay: flex;\r\n\t\t\tflex-direction: row;\r\n\t\t\tflex-wrap: wrap;\r\n\t\t\tjustify-content: flex-start;\r\n\t\t\tgap: 0.25rem;\r\n\t\t\tpadding: 0 var(--edge-pad) 1rem;\r\n\t\t\tfont-size: 0.8rem\r\n\t\t}\n.ugc_detail-panel .overview .tags li {\r\n\t\t\t\tdisplay: block;\r\n\t\t\t\tbackground-color: hsla(var(--theme-interact-hsl), 0.1);\r\n\t\t\t\tpadding: 0.25em 0.75em;\r\n\t\t\t\tborder-radius: 1em;\r\n\t\t\t\tbox-shadow: 0 0.25rem 2rem rgba(0,0,0,0.5);\r\n\t\t\t}\n.ugc_detail-panel .credits {\r\n\t\tmargin: 1rem var(--edge-pad)\r\n\t}\n.ugc_detail-panel .credits .author {\r\n\t\t\tmargin-left: .5rem;\r\n\t\t}\n.ugc_detail-panel .credits ul {\r\n\t\t\tlist-style-type: none;\r\n\t\t\tmargin-left: .5rem;\r\n\t\t}\n.ugc_detail-panel .links, .ugc_detail-panel .margin {\r\n\t\tmargin: 1rem var(--edge-pad);\r\n\t}\n.ugc_detail-panel .details {\r\n\t\tmargin: 1rem var(--edge-pad)\r\n\t}\n.ugc_detail-panel .details .details-list {\r\n\t\t\tpadding: 1rem var(--edge-pad);\r\n\t\t\tlist-style-type: none;\r\n\t\t\tdisplay: flex;\r\n\t\t\tflex-direction: column;\r\n\t\t\tflex-wrap: wrap;\r\n\t\t\tjustify-content: flex-start\r\n\t\t}\n.ugc_detail-panel .details .details-list .details-list-item {\r\n\t\t\t\tdisplay: flex;\r\n\t\t\t\tflex-direction: row;\r\n\t\t\t\talign-items: center\r\n\t\t\t}\n.ugc_detail-panel .details .details-list .details-list-item label {\r\n\t\t\t\t\tmargin-right: 0.5rem;\r\n\t\t\t\t}\n.ugc_detail-panel .history-stats {\r\n\t\tdisplay: none\r\n\t}\n.ugc_detail-panel .history-stats.Map {\r\n\t\t\tdisplay: block;\r\n\t\t}',""]);const o=n},3924:(t,e,s)=>{s.r(e),s.d(e,{default:()=>o});var i=s(8081),r=s.n(i),a=s(3645),n=s.n(a)()(r());n.push([t.id,'\r\n\t.discovery-parent .discovery-categories {\r\n\t\tdisplay: flex;\r\n\t\tflex-direction: row;\r\n\t}\r\n\r\n.ugc_results_wrapper {\r\n\tdisplay: flex;\r\n\tflex-direction: column;\r\n\tjustify-content: center;\r\n\talign-items: center;\r\n\twidth: 100%\r\n}\r\n\r\n.ugc_results_wrapper .ugc_results {\r\n\t\tlist-style-type: none;\r\n\t\tdisplay: grid;\r\n\t\tgrid-template-columns: repeat(auto-fill, minmax(min(15rem, 100%), 1fr));\r\n\t\tgrid-column-gap: 1.5rem;\r\n\t\t-moz-column-gap: 1.5rem;\r\n\t\t     column-gap: 1.5rem;\r\n\t\tpadding: 0.5rem;\r\n\t\tjustify-items: center;\r\n\t\talign-items: center;\r\n\t\talign-content: center;\r\n\t\twidth: 100%;\r\n\t\tmax-width: 70rem;\r\n\t}\r\n\r\n.ugc_item {\r\n\t--length: 10rem;\r\n\t--lengthMax: 50vh;\r\n\t--width: 15rem;\r\n\t--widthMax: 95vw;\r\n\twidth: var(--width);\r\n\theight: var(--length);\r\n\tmax-width: var(--widthMax);\r\n\tmax-height: var(--lengthMax);\r\n\tpadding: 0;\r\n\tmargin: 0.8rem;\r\n\tdisplay: flex;\r\n\tflex-direction: column;\r\n\tjustify-content: flex-start;\r\n\talign-items: center;\r\n\tbackground-color: rgba(0,0,0,0.25);\r\n\tfont-weight: bold;\r\n\ttext-shadow: -0.1rem 0.1rem 0.1rem #000, 0.1rem 0.1rem 0.1rem #000;\r\n\t/* animation: fade-in var(--time-state) linear; */\r\n\tposition: relative;\r\n\tz-index: 0;\r\n\t--rarity: #FFF\r\n}\r\n\r\n.ugc_item::before {\r\n\t\tdisplay: block;\r\n\t\tcontent: "";\r\n\t\t--padding: -0.5em;\r\n\t\ttop: var(--padding);\r\n\t\tleft: var(--padding);\r\n\t\tright: var(--padding);\r\n\t\tbottom: var(--padding);\r\n\t\tborder-radius: var(--theme-border-radius);\r\n\t\tposition: absolute;\r\n\t\tborder: none;\r\n\t\tborder-width: 0.18em;\r\n\t\tborder-style: solid;\r\n\t\t-o-border-image: linear-gradient(\r\n\t\t\tto bottom,\r\n\t\t\thsla(var(--theme-interact-hsl), 1),\r\n\t\t\thsla(var(--theme-interact-hsl), 1) 7%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0) 8%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0) 12%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0.25) 13%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0.25) 87%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0) 88%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0) 92%,\r\n\t\t\tvar(--rarity) 93%,\r\n\t\t\tvar(--rarity)\r\n\t\t) 1 100%;\r\n\t\t   border-image: linear-gradient(\r\n\t\t\tto bottom,\r\n\t\t\thsla(var(--theme-interact-hsl), 1),\r\n\t\t\thsla(var(--theme-interact-hsl), 1) 7%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0) 8%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0) 12%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0.25) 13%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0.25) 87%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0) 88%,\r\n\t\t\thsla(var(--theme-interact-hsl), 0) 92%,\r\n\t\t\tvar(--rarity) 93%,\r\n\t\t\tvar(--rarity)\r\n\t\t) 1 100%;\r\n\t\tborder-image-slice: 1;\r\n\t\topacity: 0.4;\r\n\t\ttransition: opacity var(--time-state) linear,\r\n\t\t\tborder-width var(--time-active) linear;\r\n\t}\r\n\r\n.ugc_item:hover {\r\n    background-color: rgba(255,255,255,1);\r\n\t\tcolor: #000;\r\n\t\ttext-shadow: 0 0 1rem #fff, 0 0 0.5rem #fff\r\n\t}\r\n\r\n.ugc_item:hover::before {\r\n\t\t\tborder-width: 0.25em;\r\n\t\t}\r\n\r\n.ugc_item.is343 {\r\n\t\t--rarity: var(--rarity-store);\r\n\t}\r\n\r\n.ugc_item.isRec {\r\n\t\t--rarity: var(--theme-activate);\r\n\t}\r\n\r\n.ugc_item .thumbnail {\r\n\t\theight: 80%;\r\n\t\twidth: 100%;\r\n\t\ttop: 0;\r\n\t\tposition: absolute;\r\n\t\tpointer-events: none;\r\n\t\tbackground-size: cover;\r\n\t\tbackground-repeat: no-repeat;\r\n\t\tbackground-position: center center;\r\n\t\tbackground-color: rgba(0,0,0,0.5);\r\n\t\ttransition: opacity var(--time-state) linear;\r\n\t\topacity: 0;\r\n\t\tz-index: 0;\r\n\t}\r\n\r\n.ugc_item .titles {\r\n\t\tdisplay: flex;\r\n\t\tflex-direction: row;\r\n\t\tjustify-content: center;\r\n\t\talign-items: center;\r\n\t\theight: 20%;\r\n\t\tmax-width: 100%;\r\n\t\tz-index: 1;\r\n\t\tposition: relative;\r\n\t\toverflow: hidden;\r\n\t\tfont-size: 0.9em;\r\n\t\ttop: 80%\r\n\t}\r\n\r\n.ugc_item .titles .name {\r\n\t\t\toverflow: hidden;\r\n\t\t\tword-wrap: break-word;\r\n\t\t\tword-wrap: break-word;\r\n\t\t\ttext-overflow: ellipsis;\r\n\t\t\twhite-space: nowrap; \r\n\t\t\tpadding: 0 0.25rem;\r\n\t\t}\r\n\r\n.ugc_item .titles .icon-masked {\r\n\t\t\topacity: 0.5;\r\n\t\t}\r\n\r\n.ugc_item .badges {\r\n\t\tdisplay: flex;\r\n\t\tposition: absolute;\r\n\t\ttop: 0.25em;\r\n\t\tright: 0.5em;\r\n\t\topacity: 0.5\r\n\t}\r\n\r\n.ugc_item .badges .badge-343i {\r\n\t\t}\r\n\r\n.ugc_search_wrapper .page-controls_wrapper {\r\n\t\tposition: relative\r\n\t}\r\n\r\n.ugc_search_wrapper .page-controls_wrapper .placeholder_throbber {\r\n\t\t\tmargin: 0;\r\n\t\t\tposition: absolute;\r\n\t\t\tleft: 0;\r\n\t\t\ttop: -1.2em;\r\n\t\t}\r\n\r\n.ugc_search_wrapper .ugc_search-options {\r\n\t\tdisplay: flex;\r\n\t\tflex-direction: row;\r\n\t\tflex-wrap: wrap;\r\n\t\talign-items: center;\r\n\t\tjustify-content: flex-start;\r\n\t\tpadding: 0.5rem;\r\n\t\tmargin-bottom: 2rem;\r\n\t\tbox-shadow: 0 1rem 1rem rgba(0,0,0,0.25)\r\n\t}\r\n\r\n.ugc_search_wrapper .ugc_search-options .ugc_search_submit {\r\n\t\t\tfont-size: 1.25em;\r\n\t\t\tpadding: 0.5em;\r\n\t\t}\r\n\r\n.ugc_search_wrapper .ugc_search-options .ugc_search-term_wrapper {\r\n\t\t\tmargin-top: 0.5rem;\r\n\t\t\tmin-width: 16ch;\r\n\t\t\tdisplay: flex;\r\n\t\t\tflex-direction: row;\r\n\t\t\talign-items: center;\r\n\t\t\talign-content: center;\r\n\t\t\tjustify-content: center;\r\n\t\t\tposition: relative;\r\n\t\t\tborder: 0;\r\n\t\t\tborder-bottom: 0.2rem solid hsla(var(--theme-text-hsl), 0.25);\r\n\t\t\tbackground-color: rgba(0,0,0,0.15)\r\n\t\t}\r\n\r\n.ugc_search_wrapper .ugc_search-options .ugc_search-term_wrapper input {\r\n\t\t\t\tpadding: 0.5em;\r\n\t\t\t\tmargin: 0 0.25rem;\r\n\t\t\t\tborder: 0;\r\n\t\t\t\tbackground-color: transparent;\r\n\t\t\t\twidth: 100%;\r\n\t\t\t\tcolor: var(--theme-text);\r\n\t\t\t\tfont-size: 1.25em;\r\n\t\t\t}\r\n\r\n.ugc_search_wrapper .ugc_search-options .option {\r\n\t\t\tdisplay: flex;\r\n\t\t\tflex-direction: column;\r\n\t\t\tpadding: 0 0.5rem\r\n\t\t}\r\n\r\n.ugc_search_wrapper .ugc_search-options .option button {\r\n\t\t\t\theight: 3rem;\r\n\t\t\t}\r\n\r\n.ugc_search_wrapper .ugc_search-options .option input[type=text] {\r\n\t\t\t\tborder: 0;\r\n\t\t\t\tborder-bottom: 0.2rem solid hsla(var(--theme-text-hsl), 0.25);\r\n\t\t\t\tbackground-color: rgba(0,0,0,0.15);\r\n\t\t\t\theight: 2rem;\r\n\t\t\t\tcolor: var(--theme-text);\r\n\t\t\t\tpadding: 0 0.5rem;\r\n\t\t\t}\r\n\r\n.ugc_search_wrapper .ugc_search-options .option-group {\r\n\t\t\tdisplay: flex;\r\n\t\t\tflex-direction: row;\r\n\t\t\tflex-wrap: wrap\r\n\t\t}\r\n\r\n.ugc_search_wrapper .ugc_search-options .option-group .option {\r\n\t\t\t\tpadding: 0;\r\n\t\t\t}',""]);const o=n},8167:(t,e,s)=>{var i=s(3379),r=s.n(i),a=s(7795),n=s.n(a),o=s(569),l=s.n(o),d=s(3565),c=s.n(d),h=s(9216),u=s.n(h),g=s(4589),p=s.n(g),m=s(3622),v={};v.styleTagTransform=p(),v.setAttributes=c(),v.insert=l().bind(null,"head"),v.domAPI=n(),v.insertStyleElement=u();var f=r()(m.default,v);if(!m.default.locals||t.hot.invalidate){var y=!m.default.locals,b=y?m:m.default.locals;t.hot.accept(3622,(e=>{m=s(3622),function(t,e,s){if(!t&&e||t&&!e)return!1;var i;for(i in t)if((!s||"default"!==i)&&t[i]!==e[i])return!1;for(i in e)if(!(s&&"default"===i||t[i]))return!1;return!0}(b,y?m:m.default.locals,y)?(b=y?m:m.default.locals,f(m.default)):t.hot.invalidate()}))}t.hot.dispose((function(){f()}));m.default&&m.default.locals&&m.default.locals},1606:(t,e,s)=>{var i=s(3379),r=s.n(i),a=s(7795),n=s.n(a),o=s(569),l=s.n(o),d=s(3565),c=s.n(d),h=s(9216),u=s.n(h),g=s(4589),p=s.n(g),m=s(3924),v={};v.styleTagTransform=p(),v.setAttributes=c(),v.insert=l().bind(null,"head"),v.domAPI=n(),v.insertStyleElement=u();var f=r()(m.default,v);if(!m.default.locals||t.hot.invalidate){var y=!m.default.locals,b=y?m:m.default.locals;t.hot.accept(3924,(e=>{m=s(3924),function(t,e,s){if(!t&&e||t&&!e)return!1;var i;for(i in t)if((!s||"default"!==i)&&t[i]!==e[i])return!1;for(i in e)if(!(s&&"default"===i||t[i]))return!1;return!0}(b,y?m:m.default.locals,y)?(b=y?m:m.default.locals,f(m.default)):t.hot.invalidate()}))}t.hot.dispose((function(){f()}));m.default&&m.default.locals&&m.default.locals},1496:(t,e,s)=>{s.r(e),s.d(e,{Discovery:()=>g,discovery:()=>p,placeholderUGCResult:()=>u});var i=s(802),r=s(2165),a=s(7786),n=(s(6664),s(4136)),o=s(5959),l=s(5261);s(8167);class d extends i.w{constructor(){super(),window.addEventListener("keydown",(t=>{t.defaultPrevented||!0===this.state.visible&&"Escape"===t.key&&(this.hide(),t.preventDefault())}),!0),r.u.on("hide-panel",(()=>this.hide()))}get defaultState(){return{visible:!1,asset:{}}}hide(){this.state.visible&&(this.setState({visible:!1}),history.pushState(null,"Halosets","#"),document.body.style.overflow="auto")}toggleVisibility(){this.setState({visible:!this.state.visible}),document.body.style.overflow="auto"}displayAsset(t,e){e?history.replaceState({path:`${t?.id}`},"Cylix Guide",`#${t.cylixURI}`):history.pushState({path:`${t?.id}`},"Cylix Guide",`#${t.cylixURI}`),this.scrollToTop(),this.state={...this.defaultState,asset:t,visible:!0},document.body.style.overflow="hidden",this.render()}scrollToTop(){const t=document.querySelector("#ugc_detail-panel_header");t&&t.scrollIntoView()}render(){if(!this.state.visible)return a.k9.bind(document.querySelector(".js--item-panel"))``;const t=this.state.asset;return t?a.k9.bind(document.querySelector(".js--item-panel"))`
			...
			<div class=${`dbItemPanel_wrapper ugc_detail-panel${t.is343?" is343":""}${t.isRecommended?" isRec":""}`}>
				...
				>
					...
					<div class=${`history-stats ${t.assetKind}`}>
						...
						${"Map"===t.assetKind?t.historyPlays.length>2?this.chartCanvasPlays():"No Data":""}
					</div>
					<div class="credits">
		...
		`:void 0}chartCanvasPlays(){return a.k9.wire(this,":chartCanvasPlays")`
			...
			></canvas>
		`}renderHistoryPlays(){const t=document.getElementById("chartCanvasPlays");if(!t)return;const e=[...this.asset.historyPlays];if(!e||e.length<2)return;let s=0;const i=e.map((([t,e])=>(s+=e,[t,s])));this.playChart&&this.playChart.destroy(),this.playChart=new l.ZP(t,{type:"line",data:{labels:i.map((t=>new Date(`${t[0]}T18:05:03.402Z`).toLocaleDateString())),datasets:[{label:"Day",data:e.map((t=>t[1])),cubicInterpolationMode:"monotone",tension:.4,borderColor:"#2dbfe1",backgroundColor:"#0d2436"},{label:"Overall",data:i.map((t=>t[1])),cubicInterpolationMode:"monotone",tension:.4,borderColor:"#8a3513",backgroundColor:"#2b1005"}]},options:{interaction:{intersect:!1,mode:"index"},scales:{x:{ticks:{autoSkip:!0,maxTicksLimit:14}},y:{suggestedMin:5,type:"logarithmic"}},animation:!1}})}get defaultImage(){return"https://hi.cylix.guide/ugc/images/default.jpg"}async getWaypointAsset(){try{const t=new URL(`/api/${this.state.asset.cylixURI}`,`https://${window.location.host.replace("beta.","")}`),e=await fetch(t,{headers:{Accept:"application/json"}});if(!e||!e.ok)throw console.error("[UGCDetailPanel.getWaypointAsset] Failed to fetch",e),new Error(e.status);const s=await e.json();console.log("res!",s)}catch(t){console.error("[UGCDetailPanel.getWaypointAsset]",t)}}get xugcLink(){const t=`/ugc/halo-infinite/${this.state.asset?.cylixUGCKind}/${this.state.asset?.id}?v=${this.state.asset?.version}`;return`${new URL(t,"https://xugc.halo.info")}`}get waypointLink(){return`${new URL(this.state.asset.waypointBrowserURI,"https://www.halowaypoint.com")}`}async getMapStats(){if(this._mapStats)return this._mapStats}get asset(){return this.state.asset}}const c=new d;var h=s(758);s(1606);const u=a.k9.wire()`
	<button
		class='ugc_item'
...
`;class g extends i.w{async init(){this.search=new m,this.manifest=new y,this.recommended=new b,this.state.view=this.search;const{pathname:t}=new URL(window.location),e=t.split("/");console.warn(e),e?.[2]?.startsWith("recommended")&&(this.state.view=this.recommended),this.render(),await p.loadUgcStats(),this.state.view===this.search&&this.search.submit()}get defaultState(){return{}}render(){return this.html`
		...
		<div class="ugc_search-options">
			...
			<div class="option">
				...
				>
					${()=>[...p.assetSorts.entries()].map((([t,e])=>{const s=this.getQuery("sort");return!(!s||s!==t)?`<option value=${t} selected>${e}</option>`:`<option value=${t}>${e}</option>`}))}
				</select>
			</div>
			<div class="option">
		...
		`}get currentPage(){return this.state.results.map((t=>new f({result:t})))}}class f extends i.w{constructor({result:t,asset:e}){super(),t&&(this.asset=t),e&&(this.asset=e),p.registerAsset(`${this.id}/${this.version}`,this)}render(){return this.html`
			<button
		...
		`}}class w extends i.w{init(t){this.response=t,t?.length&&(this.state.results=this.response),this.render()}get defaultState(){return{pageSize:24,results:[]}}render(){return console.log("ManifestView.rend",this.state.results),this.html`
			<div class="ugc_results_wrapper">
				<ul class="ugc_results">
