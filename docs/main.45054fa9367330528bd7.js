...
class CoreViewer extends component__WEBPACK_IMPORTED_MODULE_0__.Component {
	...
	coreList() {
		return lib_HTML__WEBPACK_IMPORTED_MODULE_2__.HTML.wire(this, ':coreList')`
	...
	showCore(core, skipParam = false) {
		...
		if (!skipParam)
		{
			...
			urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('coreName', core?.name ?? 'unk');
			if (core?.state?.socket)
			{
				urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('coreSocket', core?.state?.socket?.socketName ?? 'unk');
			} else {
...
class Core extends component__WEBPACK_IMPORTED_MODULE_0__.Component {
	...
	showSocket(socket) {
		...
		urlParams__WEBPACK_IMPORTED_MODULE_4__.urlParams.setSecionSetting('coreSocket', socket.socketName ?? 'unk');
	}
}
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("45054fa9367330528bd7")
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=main.45054fa9367330528bd7.js.map